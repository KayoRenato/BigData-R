...
# O parametro .SD significa Subset Data e um subset e criado considerando a coluna Species e depois
# e calculda a mediana. O resultado deve ser igual ao comando anterior.
